...
class SensitivityEngine:
    ...
    def predict_with_jacobian(
        ...
        leaky_re: np.ndarray,
        rma_prod_pop: float,
        leaky_rma_prod_pop: float,
        rma_bbb_transport: float,
        rma_deg: float,
        tta_prod: float,
        tta_deg: float,
        dox_tta_kd: float,
...
class AdjointEngine:
    ...
    def predict(
        self,
        log_prod_mouse: np.ndarray,
        log_leaky_prod_mouse: np.ndarray,
        log_bbb: float,
        log_deg: float,
        log_tta_prod: float,
        log_tta_leaky_prod: float,
        log_tta_deg: float,
        log_tta_kd: float,
        log_dox_kd: float,
        log_cno_ec50: float,
        log_clz_ec50: float,
        log_dreadd_prod: float,
        log_dreadd_ec50: float,
    ) -> np.ndarray: ...
    def vjp(
        self,
        g_mu: np.ndarray,
